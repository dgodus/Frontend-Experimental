...
@Component({
  selector: 'app-fichaegreso-new',
  templateUrl: './fichaegreso-new.component.html',
  styleUrls: ['./fichaegreso-new.component.css'],
  providers: [UserService,FichaegresoService]
})
export class FichaegresoNewComponent implements OnInit {
